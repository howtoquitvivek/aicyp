  ...
  return (
    <motion.div variants={formVariants} initial="hidden" animate="visible" className="w-full flex flex-col justify-center">
      ...
      <div className="mb-8 text-left">
        <h2 className="text-3xl font-bold text-neutral-900 mb-2.5 tracking-tight leading-tight">Welcome back</h2>
        <p className="text-sm text-neutral-500 font-medium">Sign in to access your farm dashboard.</p>
      </div>

      {error && (
        <div className="flex items-start gap-2.5 p-3.5 rounded-xl bg-red-50 text-red-700 text-sm border border-red-100 mb-6 animate-shake">
      ...
      <div className="flex items-center gap-4 my-8">
        ...
        <span className="text-xs text-neutral-400 font-bold uppercase tracking-wider">or sign in with email</span>
        <div className="flex-1 h-px bg-neutral-200" />
      </div>
      ...
      <form className="flex flex-col gap-5" onSubmit={handleEmailLogin}>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          />
          <div className="text-right text-xs font-semibold text-emerald-600 hover:text-emerald-700 transition-colors mt-1">
